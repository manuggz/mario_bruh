...
class LevelMapHandler:
    ...
    def create_camera_rect(self, rect_camera_visible):
        ...
        for i in range(n_rows):
            for j in range(n_columns):
                ...
                if tile_index != BLOQUE_NIL:
                    ...
                    image_map_tile.blit(self.tiles, ((j_matrix - j_init_matriz)* TILE_SIZE, (i_matrix - i_init_matriz)* TILE_SIZE), src_srfc_tile_rect)
